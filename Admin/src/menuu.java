...
public class menuu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try{ 	
            ...
            ResultSet rs;
            String query = "select demandes.id,demandes.status,etudiants.nom,etudiants.prenom,documents.type_doc,etudiants.apoge,date_demande "
            		+ "from demandes,etudiants,documents "
            		+ "where demandes.id_etd =etudiants.apoge and documents.id = demandes.id_docum and (status='accepte' or status='refuse')";
        	...
        	public void actionPerformed(ActionEvent e) {
        		int ligne =rSTableMetro3.getSelectedRow();
        	        		...
        	        		//	JOptionPane.showInternalMessageDialog(null, "Selectionner une demande");
        	                    ...
        	                    try {
        	                    	if(typedoc.equalsIgnoreCase("attestation de reussite")) {
