...
<html lang="en">
    ...
    <body>
        <div class="container h-100 w-100 d-flex">
            ...
            <span class="bg-dark text-xl row mb-5 text-white text-center justify-content-center fw-bold fs-3">SERVICE ESCOLARITE</span>
            ...
            <button type="button" class="btn btn-success w-100 btn-block p-3" id="success" name="success" >Success!</button>
                ...
                <form id="loginform" name="loginform">
                    ...
                    <button type="submit" id="login-submit" name="login-submit" class="btn btn-block btn-primary w-100">Login</button>
                </form>
